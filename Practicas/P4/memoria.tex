...
\subsection{Filtro IIR y filtro IIR con la función \texttt{filter}}
	...
	El código se puede ver en la sección \color{deepred}\nameref{code1}\color{black} y en \color{deepred}\nameref{code2}\color{black}. Ambos producen la misma salida. La única diferencia con respecto al código de la práctica anterior es que se calculan los polos del resultado.\\
...
El código de este apartado se puede ver en \color{deepred}\nameref{code3}\color{black}.\\
...
Podemos encontrar el código en \color{deepred}\nameref{code4}\color{black}.\\
...
Se puede ver el código en la sección \color{deepred}\nameref{code5}\color{black}.\\
...
Este código está incluido en la sección \color{deepred}\nameref{code6}\color{black}.\\
...
El código de este apartado está en \color{deepred}\nameref{code7}\color{black}.\\
